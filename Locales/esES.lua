...
--@localization(locale="esES", format="lua_additive_table", handle-unlocalized="english", escape-non-ascii=false, table-name="phrases", same-key-is-true=false, namespace="Phrases")@
